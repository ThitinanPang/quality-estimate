...
@section('content')
    ...
    {{-- ตัวอย่าง excel --}}
    <a href="{{ route('users.template') }}" class="absolute left-[370px] top-[215px] w-[174px] h-[30px] gap-2 border rounded-[10px] flex items-center justify-center bg-[#FFCE00]">
                ...
                @if ($result->num_rows > 0)
                    @while ($row = $result->fetch_assoc())
                        ...
                        <tr class="{{ $rowColor }}">
                            ...
                            <td class="px-4 py-2 border-b text-center align-middle first-letter:uppercase">{{ $row['status'] }}</td>
