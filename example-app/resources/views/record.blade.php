...
@section('content')
    <div class="flex flex-col items-center justify-center">
        <div class="flex items-center h-[40px] mt-[28px]  mr-[800px]">
            <p class="text-[32px]">โปรดใส่หัวข้อ</p>
            <svg class="ml-[20px]" width="19" height="19" viewBox="0 0 19 19" fill="none"
            ...
            <p class=" absolute text-[24px] left-[1130px]">ปีการศึกษา</p>
            <div class="absolute w-[113px] h-[36px] left-[1250px] top-[161px] 
        ...
        <p class="text-[32px] mr-[460px] mt-5">AUN-QA 1_Expected Learning Outcomes</p>
        <div class="w-[1130px] h-[150px] 
                 bg-[#DBDBDB] border border-black 
                 shadow-[0_4px_4px_rgba(0,0,0,0.25)] 
                 rounded-[12px] box-border mt-10 ml-[85px] items-center p-[30px]">
