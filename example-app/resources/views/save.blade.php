...
@section('content')
    <div class="flex flex-col items-center justify-center">
        ...
        <div class="w-[1032px] h-[213px] bg-[#DBDBDB] border border-black rounded-[39px] mt-[32px] pl-[40px] pt-[10px]">
            ...
            <select name="" id="" class="w-[918px] h-[42px] border rounded-[5px] bg-white mt-[9px] pl-3">
        ...
        <div class="w-[1040px] h-[220px] bg-[#DBDBDB] border border-black rounded-[39px] mt-[32px] pl-[40px] pt-[10px]">
            ...
            <input type="text" name="" id="" class="pl-3 w-[918px] h-[42px] rounded-[5px] bg-white border mt-[9px]">
        ...
        @foreach ($aunqaTopics as $index => $topic)
                    ...
                    <div class="flex justify-between mt-2">
                        @for ($k = 1; $k <= 7; $k++)
                            <label class="flex flex-col items-center">
                                ...
                                <input type="radio" name="onlyone_{{$index + 1}}_{{$j}}" value="{{$k}}"
            ...
            <div class="w-[1040px] h-[126px] bg-[#DBDBDB] border border-black rounded-[39px] mt-[32px] pl-[40px] pt-[10px]">
                ...
                <p type="text" name="" id="overall-opinion_{{$index}}"
