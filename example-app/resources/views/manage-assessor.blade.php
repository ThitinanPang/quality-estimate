                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4 border text-center">
                                <select name="" id="" class="border">
                                    ...
                                    <option value="" class="text-center">ประธานคนนอก</option>
                                </select>
                            </td>
                            <td class="px-4 border text-center">
                                <div x-data="{ open: false }" class="relative">
                                    ...
                                    <!-- Modal -->
                                    <div x-show="open" class="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
                                        <div class="w-[400px] flex bg-[#FFCE00]">
                                        ...
                                        <div @click.away="open = false" class="bg-white p-6 rounded-lg w-[400px] shadow-lg">

                                            <h2 class="text-xl font-bold mb-4">เลือกผู้ใช้จากคณะ {{ $faculty->name }}</h2>

                                            <select name="assessor_user_id" class="w-full p-2 border mb-4">
                                            ...
                                            <div class="flex justify-end gap-2">
                                                <button @click="open = false"
                                                    class="px-4 py-2 border rounded hover:bg-gray-200">ปิด</button>
                                                <button type="submit"
                                                    class="px-4 py-2 bg-[#FFCE00] border rounded hover:bg-yellow-300">บันทึก</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
