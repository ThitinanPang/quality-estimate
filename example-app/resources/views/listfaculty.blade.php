...
@section('content')
    <div class="flex ml-[90px] mt-[70px]">
        ...
        <a href="{{ route('faculty.template') }}"
            class="w-[174px] text-[20px] h-[30px] mt-[15px] ml-[20px] gap-2 border rounded-[10px] flex items-center justify-center bg-[#FFCE00]">
    ...
    <div class="flex ml-[90px] gap-2 mt-[10px]">
        <a href="{{ route('listfaculty') }}"
            class="{{ request()->routeIs('listfaculty') ? 'bg-[#BEBEBE]' : 'hover:bg-[#D9D9D9]' }} w-[135px] h-[38px] text-[24px] rounded-[5px] flex items-center justify-center">คณะ</a>
        <a href="{{ route('listcourse') }}"
            class="w-[135px] h-[38px] text-[24px] bg-[#D9D9D9] rounded-[5px] flex items-center justify-center">หลักสูตร</a>
    </div>
    ...
    <select name="" id="sortName"
        class="w-[79px] h-[32px] text-[20px] border rounded-r-[20px] absolute top-[158.33px] right-[380px] text-center">
    ...
    <div class="absolute left-[1135px] top-[320px]">
        <span class="text-[20px]">กลุ่มสาขาวิชา :</span>
            ...
            <table id="myTable" class="w-full">
                <thead class="bg-[#FFCE00] h-[66px]">
                    <tr>
                        ...
                        <th class="text-[28px] text-left pl-4">คณะภายใน มหาวิทยาลัยบูรพา</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($faculties as $index => $faculty)
                        <tr>
                            <td class="px-2 py-2 text-center text-[28px] w-[120px]">{{$index + 1}}</td>
                    ...
                    @empty
                        <tr>
                            <td class="px-4 py-2 text-center text-[28px]" colspan="2">
                                ไม่มีข้อมูล
                            </td>
                        </tr>
                    @endforelse
