    ...
    <div class="flex pl-[85px] pt-[10px] w-full">
        <div class="w-[1500px] h-[380px] overflow-auto">
            <table id="myTable" class="w-[1500px] h-[390px] border-collapse">
                ...
                <tbody>
                    @php $hasData = false;
                    $no = 1; @endphp@foreach($faculties as $faculty)@foreach($faculty->courses as $course)@php $hasData = true; @endphp<tr x-data="{ 
                {{-- เก็บชื่อที่ถูกเลือกในแต่ละบทบาทของแถวนี้ --}}
                selectedInRow: {
                    chairperson: '',
                    position: '',
                    intern: '',
                ...
                {{-- ฟังก์ชันเช็คว่าชื่อนี้ถูกใช้ใน Role อื่นไปหรือยัง --}}
                ...
                <td class="px-4 py-4 border text-center">
                    <select name="courses[{{ $course->id }}][assessment_type]" class="border text-center">
