...
@section('content')
    ...
    <div class="flex flex-col items-center justify-center ml-[110px] mt-[42px]">
        <p class="text-[36px] w-full text-left inline-flex items-center">รายงานสรุปผลการตรวจประเมินภายใน ระดับหลักสูตร
            ...
            {{-- export เป็น pdf --}}
            <a href="{{ route('report.export.pdf', ['year_report1' => request('year_report1')]) }}" target="_blank"
                rel="noopener">
    ...
    <p class="text-[24px] w-full text-left ml-[110px] mt-2">รายงานที่ 3 ผลการตรวจประเมินการประกันคุณภาพการศึกษาภายใน
        ระดับหลักสูตร
        ตามเกณฑ์ AUN-QA Version 4.0 (Overall Verdict) <br> ประจำปีการศึกษา {{ $yearReport3 }} (ตรวจประเมินแบบหนึ่งวัน จำนวน
                    ...
                    @else
                        @foreach ($faculties as $index => $faculty)
                            ...
                            <tr>
                                ...
                                {{-- ภาพรวมคณะ --}}
                                <td class="px-4 border text-[24px] text-center">{{ count($facultyType1CourseNames) ?: '-' }}</td>
                                <td class="px-4 border text-[24px] text-center">
