...
@section('content')
    <p class="absolute w-[500px] h-[53px] left-[85px] top-[200px] font-normal text-[40px] leading-[54px]">
        ข้อมูลผู้ดูแลระดับมหาวิทยาลัย</p>
    {{-- ตัวอย่าง excel --}}
    <a href="{{ route('users.template') }}"
        class="absolute left-[430px] top-[210px] text-[20px] w-[174px] h-[30px] gap-2 border rounded-[10px] flex items-center justify-center bg-[#FFCE00]">
    ...
    <div class="flex">
        ...
        <button onclick="window.location.href='{{route('university')}}'"
            class="{{ request()->routeIs('university') ? 'bg-[#BEBEBE]' : 'hover:bg-[#D9D9D9]' }} w-[305px] h-[38px] rounded-[5px] hover:bg-[#BEBEBE] text-[24px] ml-[10px] mt-[150px]">ผู้ดูแลระดับมหาวิทยาลัย</button>
    </div>
